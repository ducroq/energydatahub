...
### H6 — A declared `MEMBER_MAPPED_FEEDS` set plus member homogeneity is a sufficient discriminator for member drift
...
**Review by**: 2026-10-01, or immediately when a new per-location feed is added — that is the moment the gap bites.

### H7 — Scoping the diagnostic-key exemption to member drift is enough
